...
class SearchTextForm(forms.ModelForm):
    ...
    class Meta:
        model = TblText
        fields = ('header', 'user', 'create_date', 'modified_date', 'creation_course', 'language', 'text_type', 'emotional', 'write_tool',
                  'write_place', 'education_level', 'self_rating', 'student_assesment', 'creation_course', 'pos_check', 'error_tag_check')
